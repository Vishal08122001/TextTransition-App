  ...
  return (
    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
      <div className="container-fluid">
        {/* Neeche jo humne kiya {props.title} */}
        <Link className="navbar-brand" to="/" style={{ fontWeight: 'bold', fontSize: '25px', fontFamily: 'fantasy' }}>{props.title}</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link active" aria-current="page" to="/">A Text-Analyzer App</Link>
            </li>
          </ul>
          {/* <li className="nav-item">
...
// Yha pr humne protype set kiya h 
Navbar.propTypes = {
